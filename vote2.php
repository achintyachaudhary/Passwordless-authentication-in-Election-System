...
if($con)
{
  ...
  echo"<ul class='theplan'><li class=title><span class='icon-trophy' style='color:yellow'></span><b>$ID</b></span></li><li display: inline;><b>Name:</b>$Name</li><li display: inline;><b>Party:</b>$Party</li><li><b>Area:</b>$Area</li>
<li><input type='text' name='n' value=$ID /></li>
